        ...
        setDismissHandler(() => {
            $('#overlayContent').fadeOut(250, () => {
                ...
                setOverlayContent(
                    ...
                    `A valid x64 installation of Java ${effectiveJavaOptions.suggestedMajor} is required to launch.<br><br>Please refer to our <a href="https://openwar.fr">Java Management Guide</a> for instructions on how to manually install Java.`,
                    'I Understand',
                    'Go Back'
                )
                setOverlayHandler(() => {
